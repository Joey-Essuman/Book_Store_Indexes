...
CREATE INDEX
orders_customer_id_idx ON
orders(customer_id);

CREATE INDEX
orders_book_id_idx ON
orders(book_id);
...
CREATE INDEX 
books_original_language_title_sales_in_millions_idx ON
...
CREATE INDEX customers_first_name_last_name_email_address_idx ON
customers(first_name, last_name, email_address);
